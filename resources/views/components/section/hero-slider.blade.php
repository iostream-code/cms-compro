...
--}}
<section class="section-hero-slider py-12 px-6" data-section-type="hero-slider">
    <div class="max-w-5xl mx-auto">
        <p class="text-xs font-mono uppercase tracking-wide text-[#8B9490] mb-2">hero-slider</p>
        @if (empty($content))
