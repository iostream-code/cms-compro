...
--}}
<section class="section-articles-preview py-12 px-6" data-section-type="articles-preview">
    <div class="max-w-5xl mx-auto">
        <p class="text-xs font-mono uppercase tracking-wide text-[#8B9490] mb-2">articles-preview</p>
        @if (empty($content))
