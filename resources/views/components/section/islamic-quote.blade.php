...
--}}
<section class="section-islamic-quote py-12 px-6" data-section-type="islamic-quote">
    <div class="max-w-5xl mx-auto">
        <p class="text-xs font-mono uppercase tracking-wide text-[#8B9490] mb-2">islamic-quote</p>
        @if (empty($content))
