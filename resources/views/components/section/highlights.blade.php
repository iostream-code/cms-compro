...
--}}
<section class="section-highlights py-12 px-6" data-section-type="highlights">
    <div class="max-w-5xl mx-auto">
        <p class="text-xs font-mono uppercase tracking-wide text-[#8B9490] mb-2">highlights</p>
        @if (empty($content))
